...
from RGBnets.PWCNet import CustomPWCNet, PWC
...
args = PWC.PWCNet.add_model_specific_args(parser).parse_args()

if args.no_log:
  args.no_TB = True

tag = 'RGB_PWC_' + args.tag
if not args.no_TB:
  if args.log == '':
...
model = CustomPWCNet(args=args, in_channels=in_channels, time_steps=time_steps, taps=args.taps, convert='RGB').to(device)
# print(model)
